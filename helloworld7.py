...
root = Tk()
root.title("kal tak news - aapka apna akhabaar")
...
Label(f0, text="kal tak news", font="lucida 33 bold").pack()
f0.pack()
Label(f0, text="August 17, 2021", font="lucida 13 bold").pack()
f0.pack()
...
Label(f3, text=texts[0], padx=22, pady=22).pack(side="left")
